// https://www.codewars.com/kata/automorphic-number-special-numbers-series-number-6/train/javascript
...
function automorphic(n){
  ...
  const power = Math.pow(n, 2).toString();
  const last = power.length - str.length;
  if (power.substring(last, power.length) === str) {
    return 'Automorphic';
  }
  return 'Not!!'
}
